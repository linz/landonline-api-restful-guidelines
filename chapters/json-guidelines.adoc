...
Enum values (using `enum`) need to consistently use
...
* [[id]]{id}: the identity of the object. If used, IDs may be opaque strings
  or numbers. IDs are unique within some documented context, are stable
